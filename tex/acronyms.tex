...
\newacronym{OCCUR}{OCCUR}{\gls{OPeNDAP} Citation Creator}
...
\newacronym{CCL}{CCL}{Connected-component labeling}
...
\newacronym{PPS}{PPS}{Precipitation Processing System}
\newacronym{GPM}{GPM}{Global Precipitation Measurement}
\newacronym{IMERG}{IMGERG}{Integrated Multi-satellitE Retrievals for \gls{GPM}}
...
\newacronym{LAP}{LAP}{Light absorbing particle}
...
\newacronym{IIS}{IIS}{Information and Intelligent Systems}
...
\newacronym{SID}{SID}{\gls{STARE} Spatial Identifier}
\newacronym{HID}{HID}{\gls{HTM} Spatial Identifier}
...
\newacronym{DGG}{DGG}{Discrete Global Grid}
